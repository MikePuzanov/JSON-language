...
Единственное отличие заключается в том, что если мы хотим взаимодействовать с сервером, в массиве, содержащий набор команд, первым элементом должен быть адрес сервера.
